...
function loadImage() {
	...
	backImg.src = 'gamePage.jpg';
	imgFoodApple = new Image();
	imgFoodApple.src = 'food1.png';
	imgFoodBanana = new Image();
	imgFoodBanana.src = 'food2.png';
	imgFoodGrape = new Image();
	imgFoodGrape.src = 'food3.png';
	imgFoodOrange = new Image();
	imgFoodOrange.src = 'food4.png';
	imgFoodPear = new Image();
	imgFoodPear.src = 'food5.png';

    imgSlimeBlack = new Image();         //black, red, orange slimes
	imgSlimeBlack.src = 'slimeBlack.png';
	imgSlimeRed = new Image();    
	imgSlimeRed.src = 'slimeRed.png'
	imgSlimeOrange = new Image();              
	imgSlimeOrange.src = 'slimeOrange.png';
}
